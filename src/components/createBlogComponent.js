  ...
  const template = `
        <div class="create-blog-container">
            <div class="logo-container">
                <a href="/">
                    <img class="darklogo" id="logoImage" src="./logo.svg" alt="Logo" data-light-src="./logo.svg" data-dark-src="./dark-logo.svg">
                </a>
            </div>
...
function updateLogoForTheme() {
    ...
    if (logoImage) {
        ...
        const newSrc = isDarkMode ? 
            logoImage.getAttribute('data-dark-src') : 
            logoImage.getAttribute('data-light-src');
